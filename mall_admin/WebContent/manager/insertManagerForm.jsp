...
<section class="login-block">
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-sm-12">
                  <form action="<%=request.getContextPath()%>/manager/insertManagerAction.jsp" method="post" class="md-float-material form-material">
                      ...
                      <div class="auth-box card">
                          <div class="card-block">
                              <div class="row m-b-20">
                                  <div class="col-md-12">
                                      <h3 class="text-center txt-primary">매니저 등록</h3>
                                  </div>
                              </div>
                              <div class="form-group form-primary">
                                  <input type="text" name="managerId" class="form-control">
                                  <span class="form-bar"></span>
                                  <label class="float-label">매니저 ID</label>
                              </div>
                              <div class="form-group form-primary">
                                  <input type="text" name="managerName" class="form-control">
                                  <span class="form-bar"></span>
                                  <label class="float-label">매니저 이름</label>
                              </div>
                              <div class="row">
                                  <div class="col-sm-6">
                                      <div class="form-group form-primary">
                              ...
                              <div class="row m-t-30">
                                  <div class="col-md-12">
                                      <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">매니저 등록요청</button>
                                  </div>
                              </div>
                              <hr/>
                              <div class="row">
                                  <div class="col-md-10">
                                      <p class="text-inverse text-left"><a href="<%=request.getContextPath()%>/adminIndex.jsp"><b>[원래 페이지로]</b></a></p>
                                  </div>
                                  <div class="col-md-2">
