                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">updateNoticeOneForm</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
%>	
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-sm-12">
                  <form action="<%=request.getContextPath()%>/notice/updateNoticeOneAction.jsp" method="post" class="md-float-material form-material">
                      ...
                      <div class="auth-box card">
                          <div class="card-block">
                              <div class="row m-b-20">
                                  <div class="col-md-12">
                                      <h3 class="text-center txt-primary">공지 내용 수정</h3>
                                  </div>
                              </div>
								...
								<tr>
									<th>noticeContent</th>
									<td>
										<textarea rows="10" cols="40" name="noticeContent" required="required"><%=notice.getNoticeContent()%></textarea>
									</td>
								</tr>
								<tr>
									<th>managerId</th>
                              ...
                              <div class="row m-t-30">
                                  <div class="col-md-12">
                                      <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">내용 수정</button>
                                  </div>
                              </div>
                              <hr/>
                              <div class="row">
