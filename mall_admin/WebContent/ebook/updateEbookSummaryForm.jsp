...
<div id="pcoded" class="pcoded">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">ebooksummaryupdate</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-sm-12">
                  <form action="<%=request.getContextPath()%>/ebook/updateEbookSummaryAction.jsp" method="post" class="md-float-material form-material">
                      ...
                      <div class="auth-box card">
                          <div class="card-block">
                              <div class="row m-b-20">
                                  <div class="col-md-12">
                                      <h3 class="text-center txt-primary">상품 요약 수정</h3>
                                  </div>
                              </div>
	                            ...
	                            <table border = "1">
									...
									<tr>
										<td>바꿀 내용</td>
										<td>
											<textarea rows="5" cols="50" name = "newEbookSummary"></textarea>
										</td>
									</tr>
								</table>
                              ...
                              <div class="row m-t-30">
                                  <div class="col-md-12">
                                      <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">요약 수정</button>
                                  </div>
                              </div>
                              <hr/>
                              <div class="row">
                                  <div class="col-md-10">
                                      <p class="text-inverse text-left"><a href="<%=request.getContextPath()%>/ebook/ebookList.jsp"><b>[리스트로]</b></a></p>
                                  </div>
                                  <div class="col-md-2">
