...
<div id="pcoded" class="pcoded">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">고객정보 수정</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-sm-12">
                  <form action="<%=request.getContextPath()%>/client/updateClientAction.jsp" method="post" class="md-float-material form-material">
                      ...
                      <div class="auth-box card">
                          <div class="card-block">
                              <div class="row m-b-20">
                                  <div class="col-md-12">
                                      <h3 class="text-center txt-primary">고객 비번 변경</h3>
                                  </div>
                              </div>
                              
                              <div class="row m-b-20">
                                  <div class="col-md-12">
                                      <h5 class="text-center txt-primary">고객 메일 주소</h5>
                                      <h6 class="text-center txt-primary"><%=clientMail%></h6>
                                  </div>
                              </div>
                              
                              <div class="form-group form-primary">
                                  <input type="text" name="clientPw" class="form-control">
                                  <span class="form-bar"></span>
                                  <label class="float-label">새로운 비밀번호</label>
                              </div>
                              ...
                              <div class="row">
                                  <div class="col-md-10">
                                      <p class="text-inverse text-left"><a href="<%=request.getContextPath()%>/client/clientList.jsp"><b>[원래 페이지로]</b></a></p>
                                  </div>
                                  <div class="col-md-2">
