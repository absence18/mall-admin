                      ...
                      <div class="auth-box card">
                          <div class="card-block">
                              <div class="row m-b-20">
                                  <div class="col-md-12">
                                      <h3 class="text-center txt-primary">카테고리 등록</h3>
                                  </div>
                              </div>
                              ...
                              <div class="form-group form-primary">
                                  ...
                                  <label class="float-label">추가 할 카테고리 이름</label>
                              </div>
                              
                              <div class="row m-t-30">
                                  <div class="col-md-12">
                                      <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">카테고리 추가</button>
                                  </div>
                              </div>
                              <hr/>
                              <div class="row">
                                  <div class="col-md-10">
                                      <p class="text-inverse text-left"><a href="<%=request.getContextPath()%>/category/categoryList.jsp"><b>[원래 페이지로]</b></a></p>
                                  </div>
                                  <div class="col-md-2">
